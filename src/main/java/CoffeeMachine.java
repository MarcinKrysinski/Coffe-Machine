...
//        CoffeMachineResources coffeMachineResources = new CoffeMachineResources();
//        System.out.println("First " + coffeMachineResources.milk);
//        int minusMilk = 140;
//        coffeMachineResources.milkConsume(minusMilk);
//        System.out.println("2 " + coffeMachineResources.milk);
//        coffeMachineResources.milkConsume(minusMilk);
//        System.out.println("3 " + coffeMachineResources.milk);
